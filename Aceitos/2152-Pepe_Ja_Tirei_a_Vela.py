...
def main() -> None:
    ...
    for _ in range(casos):
        hora, minuto, aberto_ou_fechado = input().split()
        if aberto_ou_fechado == '1':
            print(f'{hora.zfill(2)}:{minuto.zfill(2)} - A porta abriu!')
        else:
            print(f'{hora.zfill(2)}:{minuto.zfill(2)} - A porta fechou!')
