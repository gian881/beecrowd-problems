...
def main() -> None:
    par_impar_jogador_1, valor_jogador_1, valor_jogador_2, jogador_1_roubou, jogador_2_acusou = [
        int(numero) for numero in input().split()]
    if jogador_1_roubou:
        if jogador_2_acusou:
            print('Jogador 2 ganha!')
        else:
            print('Jogador 1 ganha!')
    elif jogador_2_acusou:
        print('Jogador 1 ganha!')
    elif (valor_jogador_1 + valor_jogador_2) % 2 == 0:
        if par_impar_jogador_1:
            print('Jogador 1 ganha!')
        else:
            print('Jogador 2 ganha!')
    elif (valor_jogador_1 + valor_jogador_2) % 2 == 1:
        if par_impar_jogador_1:
            print('Jogador 2 ganha!')
        else:
            print('Jogador 1 ganha!')
